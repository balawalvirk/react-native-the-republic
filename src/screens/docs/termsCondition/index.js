...
//   const source = require('../../../assets/pdf/terms-and-conditions.pdf');
  const source =
    Platform.OS === 'ios'
      ? require('../../../assets/pdfs/terms-and-conditions.pdf')
      : {uri: `bundle-assets://pdfs/terms-and-conditions.pdf`, cache: true};
  return (
    <Modal
      isVisible={visible}
      ...
      style={{margin: 0}}>
      <MainWrapper>
        <HeaderPrimary onBackPress={toggle} title="Terms and Conditions" />
        {/* <KeyboardAvoidingScrollView>
