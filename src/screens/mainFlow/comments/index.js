...
function Comments(props) {
  ...
  const validations = () => {
    ...
    !selectedFeature
      ? setFeatureError('Please Select Feature / Functionality')
      : setFeatureError('');
    !comment
      ? setCommentError('Please wirte your comment')
      : setCommentError('');
  ...
  const handleSubmitFeedback = async () => {
    ...
    if (validations()) {
      setLoading(true);
      await Backend.submitAppFeedback({
...
//   const handleSubmitFeedbackTest = () => {
//     const myHeaders = new Headers();
//     myHeaders.append('Accept', 'application/json');

//     const formdata = new FormData();
//     formdata.append('user_id', '232');
//     formdata.append('feature', 'performance');
//     formdata.append('comment', 'Awesome');
...
//     fetch(
//       'https://republic-backend-ec60d5068468.herokuapp.com/api/submit-app-feedback',
//       requestOptions,
//     )
//       .then(response => response.text())
//       .then(result => console.log('handleSubmitFeedbackTest res: ', result))
//       .catch(error => console.error('handleSubmitFeedbackTest error: ', error));
//   };
  return (
    <MainWrapper>
      <KeyboardAvoidingScrollView>
        ...
        <ComponentWrapper>
          <SmallTitle style={[appStyles.textPrimaryColor]}>
            Your comments about the app functionality and features will help us
            improve it
          </SmallTitle>
        </ComponentWrapper>
        <Spacer height={sizes.baseMargin} />
        ...
        <ButtonColored
          ...
          //onPress={handleSubmitFeedbackTest}
          isLoading={loading}
        />
        <Spacer height={sizes.doubleBaseMargin} />
      </KeyboardAvoidingScrollView>
