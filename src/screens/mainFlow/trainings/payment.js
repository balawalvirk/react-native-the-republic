...
function Payment(props) {
    ...
    const handleSendTrainingRequest = async () => {
        setLoadingSendTrainingRequest(true)
        await Backend.sendTrainingRequest({ training_id: training.id, timeSlot_id: timeSlot.id }).
            then(res => {
    ...
    return (
        <MainWrapper>
            ...
            <PopupPrimary
                ...
                onPressButton1={handleSendTrainingRequest}
